...
const Footer = () => {
  ...
  return (
    <footer className={`${styles.paddingX} bg-primary`}>
      <div className="max-w-screen-2xl mx-auto text-white py-5 flex flex-col md:flex-row md:justify-between relative">
        <div className="max-w-screen-2xl flex justify-end w-full absolute bottom-20">
